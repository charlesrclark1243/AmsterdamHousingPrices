I downloaded data from Kaggle and used it to create models that attempted to predict housing prices in Amsterdam. The accepted model achieved an R2 score
